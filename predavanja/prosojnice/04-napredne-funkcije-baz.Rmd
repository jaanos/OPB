---
title: "Napredne funkcionalnosti na bazah"
output: 
...
## [Namestitev PostgreSQL](https://www.digitalocean.com/community/tutorials/how-to-install-and-use-postgresql-on-ubuntu-22-04) {.build}
...
ip address
```
- Preden omogočimo uporabniku `postgres` (t.j., administratorju) oddaljen priklop, mu moramo nastaviti geslo
```{bash  eval=FALSE}
psql
\password
```
...
## Definicija funkcij - primer {.build}
...
## [Prožilci - primer](http://www.postgresqltutorial.com/creating-first-trigger-postgresql/) {.build}
