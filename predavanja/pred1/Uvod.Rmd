...
## [Banka](banka.sql) - celoten SQL, narečje PSQLite - 1
...
## [Banka](banka.sql) - celoten SQL, narečje PSQLite - 2
...
## [Banka](banka.postgresql) - narečje Postgres - 2 
```{sql eval=FALSE}
-- tabela racunov
...
## [Banka](banka.postgresql) - narečje Postgres - 3
```{sql eval=FALSE}
